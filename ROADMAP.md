...
- [x] Task 55: Nâng cấp cửa sổ Train Template cho Tool Origin theo chuẩn MVP (Machine Vision Platform Trung Quốc): Tích hợp `ImageViewerControl` trực tiếp vào cửa sổ Train Template với đầy đủ tay cầm tương tác (8 tay cầm vuông góc/cạnh + tay cầm xoay màu cam + hiển thị góc xoay sinh động); bổ sung bảng danh sách thao tác Shape Operations (`No.`, `Shape`, `Add/Deduct`, `ParamSet`) phía dưới bảng điều khiển tham số; hỗ trợ xoay ROI 360 độ và cập nhật tức thì viền xanh Green Contours.
